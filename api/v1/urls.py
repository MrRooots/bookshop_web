...
from api.v1.views.customers import ApiLoginCustomerView, update_password, add_address
...
urlpatterns = [
  ...
  # Customer details manipulations section
  path('customers/<int:obj_id>/updatePassword/', csrf_exempt(update_password)),
  path('customers/<int:obj_id>/addAddress/', csrf_exempt(add_address)),
